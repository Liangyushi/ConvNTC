    ...
    def CV_triplet(self):
        ...
        for i in range(self.times):
            ...
            for k in range(k_folds):
                ...
                ## 存储每折每次的预测和真实值
                fname = 'pred_score_pkl/' + 'NCTF_hmddv3.2_' + str(i) + '_times_' + str(k) + '_foldscores.pkl'
                print(fname)
                with open(fname, 'wb') as f:  # Python 3: open(..., 'wb')
                ...
                # 保存为 CSV 文件
                fname = 'pred_score_csv/' + 'NCTF_hmddv3.2_' + str(i) + '_times_' + str(k) + '_foldscores.csv'
        ...
        fname = os.path.join('compareTF', 'NCTF_hmddv3.2_' + str(self.negs) + 'neg_results_new.csv')
