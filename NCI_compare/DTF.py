...
class Experiments(object):
    ...
    def CV_triplet(self):
        ...
        for i in range(self.times):
            ...
            for k in range(k_folds):
                ...
                if self.msi == 20:
                    ...
                    mname = mnameList[methodList.index(self.msi)]
                    print(mname)
                    fname = os.path.join('/mnt/sda/liupei/NCTF_new/ddi_nci/compare/bib_revised/1neg/cpwopt_57R_drugnci/output/'
                ...
                ## 存储每折每次的预测和真实值
                fname='pred_score_pkl/'+mname+'_'+str(i)+'_times_'+str(k)+'_foldscores_new.pkl'
                print(fname)
                ...
                # 保存为 CSV 文件
                fname='pred_score_csv/'+mname+'_'+str(i)+'_times_'+str(k)+'_foldscores_new.csv'
        ...
        fname = os.path.join('compareTF', mname + '_ddi_'+str(self.negs)+'neg_results_0.5lam_fixed_new.csv')
...
if __name__ == '__main__':
    ...
    for msi in [80]:
        ...
        fname = mname + '_Results_1neg_new.csv'
        df.to_csv(fname,index=False)  # index=False 表示不写入行索引
